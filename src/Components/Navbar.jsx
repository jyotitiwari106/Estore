    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {!user ? (
                    <button onClick={() => setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-green-500 hover:bg-green-400 transition text-white rounded-full">
                        Login
                    </button>
                ) : (
                    <div className="relative group">
                        ...
                        <ul className="hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 p-2 w-30 rounded-md text-sm z-40">
                            <li onClick={() => navigate("/my-orders")} className="text-center hover:bg-primary/10 cursor-pointer">My Order</li>
                            <li onClick={logout} className="text-center p-2 pl-3 hover:bg-primary/10 cursor-pointer">Logout</li>
                        </ul>
                    </div>
                )}
            </div>
