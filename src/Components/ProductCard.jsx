            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                         ...
                         <img key={i} src={i < 4  ? assets.star_icon : assets.star_dull_icon} alt="" className='md:w-3 w3' />
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-green-600" onClick={(e)=> {e.stopPropagation(); }}>
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-green-200 border border-green-300
                             md:w-[80px] w-[64px] h-[34px] rounded text-green-600 font-medium cursor-pointer"
                              onClick={() => addToCart(product._id)} >
                                <img src={assets.cart_icon} alt="cart icon" />
                                Add
                            </button>
                        ) : (
                            <div className="flex items-center justify-center gap-2 md:w-20 w-16 
                            h-[34px] bg-green-600/25 rounded select-none">
